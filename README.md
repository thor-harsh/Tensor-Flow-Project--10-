...
**Important Note: Before Jumping to the code please go through the Natural Language Processing (PubMed 200k RCT) dataset by clicking on this link( [https://www.kaggle.com/competitions/nlp-getting-started/data](https://paperswithcode.com/dataset/pubmed-rct) ).**
